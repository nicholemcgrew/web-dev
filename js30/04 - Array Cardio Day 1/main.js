    ...
    const passed = inventors.filter(inventor => (inventor.passed >= 1600 && inventor.passed < 1700))
    const sixteen = inventors.filter(inventor => inventor.year >= 1800 && inventor.year < 1900)
    ...
    const passed2 = inventors.sort((a, b) => a.passed > b.passed ? 1 : -1)
